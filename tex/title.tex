...
\title{Improving Deep Reinforcement Learning with Insights from Classical Control, Systems Theory, and Deferentiable Programming}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\report{Dissertation} \degree{Doctor of Philosophy} \degreemonth{December} \degreeyear{2021}
\defensemonth{March} 
\defenseyear{2022}
