...
\author{Sean M Gillen}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DECLARATIONS FOR FRONT MATTER %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\report{Dissertation} \degree{Doctor of Philosophy} \degreemonth{March} \degreeyear{2022}
\defensemonth{March} 
\defenseyear{2022}
...
\othermemberC{Professor Yon Visell} % This is a member of your committee (if your department requires 4 members)
